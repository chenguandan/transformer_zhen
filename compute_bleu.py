...
def bleu_wrapper(ref_filename, hyp_filename, case_sensitive=False):
  ...
  #如果出现空格行会出现错误： Reference and translation files have different number of lines.
  #.strip()
  ref_lines = tf.gfile.Open(ref_filename).read().splitlines()
  hyp_lines = tf.gfile.Open(hyp_filename).read().splitlines()
