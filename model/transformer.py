...
class Transformer(object):
  ...
  def __init__(self, params, train):
    ...
    self.embedding_en_softmax_layer = embedding_layer.EmbeddingSharedWeights(
        params['vocab_size_en'], params["hidden_size"],
        method="matmul" if params["tpu"] else "gather")
  ...
  def decode(self, targets, encoder_outputs, attention_bias):
    ...
    with tf.name_scope("decode"):
      ...
      decoder_inputs = self.embedding_en_softmax_layer(targets)
      ...
      outputs = self.decoder_stack(
          ...
          attention_bias)
      logits = self.embedding_en_softmax_layer.linear(outputs)
      return logits
  ...
  def _get_symbols_to_logits_fn(self, max_decode_length):
    ...
    def symbols_to_logits_fn(ids, i, cache):
      ...
      decoder_input = self.embedding_en_softmax_layer(decoder_input)
      ...
      logits = self.embedding_en_softmax_layer.linear(decoder_outputs)
  ...
  def predict(self, encoder_outputs, encoder_decoder_attention_bias):
    ...
    decoded_ids, scores = beam_search.sequence_beam_search(
        ...
        initial_cache=cache,
        vocab_size=self.params["vocab_size_en"],
