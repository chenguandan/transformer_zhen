"""Train and evaluate the Transformer model using mini-data for test.
...
class Flags(object):
    def __init__(self):
        ...
        self.steps_between_evals =  1000
        self.bleu_source =  None
        self.bleu_ref =  None
        self.vocab_file =  None
        self.data_dir = "./data/translate_ende"
        self.model_dir = "./data/transformer_model"
...
def main_simple():
    flags = {
        ...
        "bleu_ref":None,
        "vocab_file":None,
        "data_dir":"./data/translate_ende",
        "model_dir":"./data/transformer_model",
        "batch_size":None,
        "train_epochs":None,
    }
    flags_obj = Flags()
    ...
    run_loop(
        ...
        bleu_source=flags_obj.bleu_source,
        bleu_ref=flags_obj.bleu_ref,
        bleu_threshold=None, #flags_obj.stop_threshold,
        vocab_file=flags_obj.vocab_file)
